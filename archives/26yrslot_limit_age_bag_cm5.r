...
f <-  p  + b0 + sq + ##b4 + b3 + b2 + b1 + sq +
    geom_point(x = 35, y = 30, colour = "black",
               cex = 4, pch = 17) +
...
##               cex = 1, pch = 1) +
    geom_point(x = 35, y = 28, colour = "black",
                 cex = 6, pch = 19) +
    geom_text(data = NULL, x = 40, y = 30, label = "= 4 bag slot") +
...
##    geom_text(data = NULL, x = 40, y = 24, label = "= 1 bag slot") +
    geom_text(data = NULL, x = 40, y = 28, label = paste("  " , "  =  SQ Min Size", sep = "  "))
...
par(new = TRUE)
plot(c(1:26), tmp.selex[-1], axes = FALSE, bty = "n", xlab = "",
     ylab = "", type = "l")
